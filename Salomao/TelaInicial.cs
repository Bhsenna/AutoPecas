        ...
        private void btnGerarRelatorio_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string caminho = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop),
                                              $"Relatorio_Faturamento_{DateTime.Now:yyyy_MM}.ods");
                ...
                using (var wb = new Workbook())
                {
                    ...
                    wsF.Cells["A2"].Value = $"Gerado em: {DateTime.Now:dd/MM/yyyy}";
                    ...
                    wsF.Cells.ImportData(dtFaturamento, 3, 0, new ImportTableOptions {});
                    ...
                    wsS.Cells["A2"].Value = $"Gerado em: {DateTime.Now:dd/MM/yyyy}";
                    ...
                    // Inserindo os dados a partir da linha 4
                    wsS.Cells.ImportData(dtServicos, 3, 0, new ImportTableOptions { });
                    ...
                    wsP.Cells["A2"].Value = $"Gerado em: {DateTime.Now:dd/MM/yyyy}";
                    ...
                    // Inserindo os dados a partir da linha 4
                    wsP.Cells.ImportData(dtProdutos, 3, 0, new ImportTableOptions { });
